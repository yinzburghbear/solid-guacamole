...
Graphite 1.0.0-alpha4 is the first design-system pass for Stash 0.31.x.
...
- Restores the scene divider/collapse handle without the blue wall.
- Shrinks scene detail action buttons.
- Hard-resets card footer chips away from Bootstrap primary blue.
- Adds broader image-overlay button cleanup.
