# Graphite Theme 1.0.0-alpha30 zero-build2
...
- Removed the scraper-menu wrapper artifact without making the actual dropdown transparent.
- Scoped the edit-toolbar padding fix instead of changing Bootstrap `.pl-0` globally.
